...
(function (document, cep) {
  ...
  csInterface.addEventListener('com.adobe.events.flash.documentChanged',function () {
    reload()
  })
  csInterface.setWindowTitle('PixiAnimate Publish Settings');
  // exec('updateDocument('+reload+")")
  // csInterface.addEventListener("com.change",
  //   function (Event)
  //   {
  ...
  // );
  // console.log(5555)
  // exec('documentChanged')
  // csInterface.evalScript("documentChanged("+reload+")", function () {
  //   console.log('change,4444444')
  // })
  // csInterface.evalScript(`function(${reload}){
